...
int main()
{
    // Input string, initialized to 20 characters
    char* inputText = "0123456789abcdefghij";
    inputText = "This = #1 test case!";

    // Output string
    char* outputText = (char*)malloc(strlen(inputText));

    runThroughAll(inputText, outputText, true);
